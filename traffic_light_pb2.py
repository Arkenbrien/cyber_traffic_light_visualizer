...
_HEADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='camera_timestamp', full_name='trafficLightVis.Header.camera_timestamp', index=1,
...
_TRAFFICLIGHTDETECTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='traffic_light_debug', full_name='trafficLightVis.TrafficLightDetection.traffic_light_debug', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='contain_lights', full_name='trafficLightVis.TrafficLightDetection.contain_lights', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='camera_id', full_name='trafficLightVis.TrafficLightDetection.camera_id', index=3,
      number=5, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
